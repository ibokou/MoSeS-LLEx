...
/** @brief Open a HID device using libusb_wrap_sys_device.
   ...
   https://libusb.sourceforge.io/api-1.0/group__libusb__dev.html#ga98f783e115ceff4eaf88a60e6439563c,
        ...
        @ingroup API
        @param sys_dev Platform-specific file descriptor that can be recognised
   by libusb.
        @param interface_num USB interface number of the device to be used as
   HID interface. Pass -1 to select first HID interface of the device.
